...
class BTCCExchange(BaseExchange):
    ...
    def place_market_order(self, symbol: str, side: str, amount: float) -> Dict[str, Any]:
        ...
        return self._request('POST', "/v1/order/create", data=data, auth=True)
    ...
    def cancel_order(self, order_id: str, symbol: Optional[str] = None) -> bool:
        ...
        try:
            self._request('POST', "/v1/order/cancel", data=data, auth=True)
            return True
        except Exception:
            return False
    ...
    def get_order_status(self, order_id: str, symbol: Optional[str] = None) -> Dict[str, Any]:
        ...
        return self._request('GET', "/v1/order/status", params=params, auth=True)

# ✅ Add this to enable quick testing from Telegram commands
def quick_buy_btc(btcc_exchange: BTCCExchange, amount: float = 0.0005) -> Dict[str, Any]:
    try:
        return btcc_exchange.place_market_order("BTC/USDT", "buy", amount)
